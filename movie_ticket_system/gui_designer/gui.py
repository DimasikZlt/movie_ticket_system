...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.add_gaenre = QtWidgets.QWidget()
        self.add_gaenre.setMaximumSize(QtCore.QSize(400, 400))
        self.add_gaenre.setObjectName("add_gaenre")
        self.formLayout = QtWidgets.QFormLayout(self.add_gaenre)
        self.formLayout.setObjectName("formLayout")
        self.name_genre_lbl = QtWidgets.QLabel(self.add_gaenre)
        ...
        self.name_genre_le = QtWidgets.QLineEdit(self.add_gaenre)
